...
<template>
    <div style="max-width: 700px; margin: 40px auto; padding: 24px; border: 1px solid #ccc; border-radius: 8px; background: #fff;">
        ...
        <input
            v-model="userInput"
            type="text"
            style="width: 100%; font-size: 1.2em; padding: 8px; border-radius: 4px; border: 1px solid #aaa;"
